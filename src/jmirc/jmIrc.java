/*
Copyright (C) 2004-2009  Juho VÃ¤hÃ¤-Herttua
...
public class jmIrc extends MIDlet implements CommandListener {
	...
	public void showAboutForm(){
		showMessage( versionInfo,"for Nokia Asha \n" +
                ...
                "jmIRC was originally developed for j2ME by: Juho Vähä-Herttua \n\n" +
                "which in turn is based on the work by: Sverre Valskrå"
               );
	}
